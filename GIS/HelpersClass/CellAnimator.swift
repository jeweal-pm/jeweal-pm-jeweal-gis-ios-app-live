...
public class CellAnimator
{
    ...
    public class func animateTableViewCell(_ cell: UITableViewCell, withDuration duration: TimeInterval, animation type: AnimationType)
    {
    ...
    public class func animateCollectionViewCell(_ cell: UICollectionViewCell, withDuration duration: TimeInterval, animation type: AnimationType)
    {
        let view = cell.contentView
        view.layer.opacity = 0.8
